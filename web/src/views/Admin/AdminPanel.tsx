      ...
      <div className="admin-container h-100">
        ...
        <div className='admin-section d-flex justify-content-between gap-4 px-5 my-4 h-75'>
          <aside className='user-page w-25 fw-bold border border-1'>
            ...
            <div><Link to={RoutePaths.adminSites} className={toggleLinkClass(RoutePaths.adminSites)}>Sites<i className="bi bi-newspaper float-end"></i></Link></div>
            <div><Link to={RoutePaths.adminSuppliers} className={toggleLinkClass(RoutePaths.adminSuppliers)}>Supliers<i className="bi bi-newspaper float-end"></i></Link></div>
